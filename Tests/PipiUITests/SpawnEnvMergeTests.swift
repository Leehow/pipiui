...
final class SpawnEnvMergeTests: XCTestCase {
    ...
    func testAllDisabledStripsManagedKeysFromDotEnvAndParent() {
        let stale: [String: String] = [
            ...
            "PIPIUI_CUA_DRIVER_VERSION": "0.0.0",
            "PIPIUI_TERMINAL_WORKER_CWD": "/old/cwd",
            "PIPIUI_TERMINAL_WORKER_WRITE_ROOTS": "[\"/old\"]",
            "PIPIUI_TERMINAL_WORKER_EXECUTABLES": "[\"stat\"]",
            "PIPIUI_TERMINAL_WORKER_MAX_COMMANDS": "99",
