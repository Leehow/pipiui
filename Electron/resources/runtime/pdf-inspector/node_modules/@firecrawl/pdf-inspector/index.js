  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '1.15.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 1.15.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
module.exports.classifyPdfAsync = nativeBinding.classifyPdfAsync
module.exports.detectPdf = nativeBinding.detectPdf
module.exports.detectVectorGridInRegion = nativeBinding.detectVectorGridInRegion
module.exports.extractPagesMarkdown = nativeBinding.extractPagesMarkdown
module.exports.extractPagesMarkdownAsync = nativeBinding.extractPagesMarkdownAsync
module.exports.extractStructureElements = nativeBinding.extractStructureElements
module.exports.extractTablesInRegions = nativeBinding.extractTablesInRegions
module.exports.extractTablesWithStructure = nativeBinding.extractTablesWithStructure
module.exports.extractTablesWithStructureAuto = nativeBinding.extractTablesWithStructureAuto
module.exports.extractTablesWithStructureCells = nativeBinding.extractTablesWithStructureCells
...
module.exports.ItemType = nativeBinding.ItemType
module.exports.OcrMode = nativeBinding.OcrMode
module.exports.PageContentSource = nativeBinding.PageContentSource
module.exports.PdfType = nativeBinding.PdfType
module.exports.processPdf = nativeBinding.processPdf
module.exports.processPdfAsync = nativeBinding.processPdfAsync
module.exports.processPdfWithOcr = nativeBinding.processPdfWithOcr
