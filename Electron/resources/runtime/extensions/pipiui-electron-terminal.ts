...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    name: 'terminal', label: 'Terminal', description: 'Control exact visible shared SSH/REPL/TUI terminals. Actions: list, open, observe, wait, send, key, resize, close, request_private_input, help. Mutations require terminal_id + fresh snapshot_id.',
