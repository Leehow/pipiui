...
export default function Panel(props) {
    ...
    const tierValue = status?.tier !== undefined
        ...
        : typeof settingsTier === "string"
            ? settingsTier
            : undefined;
    const tierLabel = tierValue === undefined
        ...
        : tierValue.trim() === ""
            ...
            : tierValue;
    const tierSourceLabel = status?.tierSource === "override" ? "手动配置" : status?.tierSource === "credential" ? "登录凭证" : "未知";
