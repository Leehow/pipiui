...
const TranscriptToolCard = memo(function TranscriptToolCard({ tool, streaming, expandSteps }: { tool: TranscriptTool; streaming?: boolean; expandSteps?: boolean }) {
  ...
  // Keep tool cards expanded while the turn is active so the user always sees
