...
export class NoAgentHomeError extends Error {
  constructor() {
    super(
      "未检测到 PI_COC_AGENT_DIR / PI_CODING_AGENT_DIR — 拒绝回退到全局 ~/.pi/agent（项目隔离）。请在宿主环境中设置其一后再试。",
    );
...
export function tryResolveAgentHome(): string | undefined {
